      ...
      <footer>
        ...
        <h4>mettā muse</h4>
          <ul>
            ...
            <li><a href="/terms">Stories</a></li>
            <li><a href="/terms">Artisans</a></li>
            <li><a href="/terms">Boutiques</a></li>
            <li><a href="/terms">Contact Us</a></li>
            <li><a href="/terms">EU Compliances Docs</a></li>
          </ul>
        </nav>
        </div>
        ...
        <h4>Quick Links</h4>
          <ul>
            <li><a href="/privacy">Orders & Shipping</a></li>
            <li><a href="/terms">Join/Login as a Seller</a></li>
            <li><a href="/terms">Payment & Pricing</a></li>
            <li><a href="/terms">Return & Refunds</a></li>
